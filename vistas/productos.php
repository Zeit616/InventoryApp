  ...
  $(document).ready(function() {
    ...
    $.ajax({
      ...
      success: function(respuesta) {
        //console.log("respuesta samaritana", respuesta);
      }
    });
      ...
      columnDefs: [{
        ...
        },
        {
          ...
          render: function(datqa, type, full, meta) {
            return "<center>" + "<span class = 'btnEditar text-primary px-1' sytle='cursor:pointer;'>" + "<i class='fas fa-pencil-alt fs-5></i>'" + "</span>" +
              "<span class = 'btnAumentar text-success px-1' sytle='cursor:pointer;'>" + "<i class='fas fa-plus-circle fs-5></i>'" + "</span>" +
              "<span class = 'btnDisminuir text-warning px-1' sytle='cursor:pointer;'>" + "<i class='fas fa-minus-circle fs-5></i>'" + "</span>" +
              "<span class = 'btnEliminar text-danger px-1' sytle='cursor:pointer;'>" + "<i class='fas fa-trash fs-5></i>'" + "</span>" + "</center>"
          }
        }
      ],
      language: {
    ...
    $.fn.dataTable.ext.search.push(
      function(settings, data, dataIndex){
        ...
        if(isNaN(precioDesde) && isNaN(precioHasta) || isNaN(precioDesde) && col_venta <= precioHasta || precioDesde <= col_venta && isNaN(precioHasta) || precioDesde <= col_venta && col_venta <= precioHasta){
          return true;
        }
        return false;
      }
